...
I've put in the hours to back up what I know with credentials that matter:
...
The OSCP holds a special place — it wasn't handed to me. I failed on my first attempt, went back to the labs, strengthened my weak areas, and came back sharper. Passing on the second attempt meant more because of that struggle.

---

## This Blog

This is where I document my journey — writeups, techniques I've learned, tools I've built opinions about, and thoughts on the field. If something here helps you pass your next exam, land a shell you'd been stuck on, or just confirms you're not the only one who spent three hours on an enum step that turned out to be simple — then this blog is doing its job.
